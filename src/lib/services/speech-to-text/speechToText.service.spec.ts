...
import { SpeechSDK, SpeechToTextService, StreamingStatus } from './speechToText.service';
...
describe('SpeechToTextService', () => {
  ...
  beforeEach(() => {
    ...
    (environment as any).silenceTimeoutMs = mockEnv.silenceTimeoutMs;
    (environment as any).azureSpeechKey = mockEnv.azureSpeechKey;
    (environment as any).azureSpeechRegion = mockEnv.azureSpeechRegion;
    ...
    TestBed.configureTestingModule({
      providers: [
        SpeechToTextService,
        { provide: SpeechSDK, useValue: mockSpeechSdk }
      ]
    });
